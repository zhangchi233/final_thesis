...
# %%
class runfig:
    pretrained_model_name_or_path = "/root/autodl-tmp/output_var_unproj_eth2/all/subset_all/input_3/train/class6/saved_model_from_checkpoint-3000"
    n_input_images =3
    n_output_noise =3
    ...
    for i in tqdm(data_range):
        ...
        with torch.no_grad():
            ...
            if refine == True:
                ...
                ref_path = os.path.join(img_dir, f'{vid:04d}_class6.png')
                src1_path = os.path.join(img_dir, f'{src1:04d}_class6.png')
                src2_path = os.path.join(img_dir, f'{src2:04d}_class6.png')
