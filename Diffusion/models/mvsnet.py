...
class FeatureNetIdw(nn.Module):
    ...
    """
    def __init__(self, norm_act=InPlaceABN):
        super(FeatureNetIdw, self).__init__()
...
class CascadeMVSNetIDW(nn.Module):
    def __init__(self, n_depths=[8, 32, 48],
                       interval_ratios=[1, 2, 4],
                       num_groups=1,
                       norm_act=InPlaceABN):
        super(CascadeMVSNetIDW, self).__init__()
        ...
        self.feature = FeatureNetIdw(norm_act)
