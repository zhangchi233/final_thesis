...
python -m accelerate.commands.launch \
  /root/autodl-tmp/ViewDiff/viewdiff/train_stabilityai.py \
  --finetune-config.io.pretrained_model_name_or_path stabilityai/stable-diffusion-2-1-base \
  --finetune-config.io.output_dir /root/autodl-tmp/ViewDiff/output_stable-diffusion-2-1-base \
  ...
  --finetune-config.cross_frame_attention.unproj_reproj_mode with_unproj_cfa \
