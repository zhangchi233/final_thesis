...
from modules.vit.vit import ViT
...
class Net(pl.LightningModule):
    def __init__(self,configs):
        ...
        self.depth_model = configs.model
    ...
    def training_step(self, batch, batch_idx):
        ...
        results = self.depth_model(new_imgs.transpose(1, 2), proj_mats, init_depth_min, depth_interval)
...
if __name__ == "__main__":
    ...
    trainer = Trainer(max_epochs=200, gpus=2,
                    ...
                    logger=logger,
                    resume_from_checkpoint='/root/autodl-tmp/project/dp_simple/ckpts/d3c_net_epoch=0.ckpt'
                    )
