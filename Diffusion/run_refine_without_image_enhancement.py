...
# models
from models.mvsnet import CascadeMVSNet,CascadeMVSNetIDW,CascadeMVSNetablation1
...
class MVSSystem(LightningModule):
    ...
    def __init__(self,args,config = None):
        ...
        if self.config.model.use_depth:
            ...
            self.depth_model = CascadeMVSNetablation1(n_depths=args.n_depths,
    ...
    def forward(self, batch):
        ...
        output["img"] = self.depth_transform(img_gt)
    ...
    def on_train_start(self) -> None:
        pth_path = f'/workspace/Diffusion/ckpts/{config.logger.exp_name}'
    ...
    def training_step(self, batch, batch_nb):
        ...
        with torch.no_grad():
            if self.global_step % 50 == 0:
                ...
                original_results= self.original_depth_model(outputs["img"], proj_mats, init_depth_min, depth_interval)
    ...
    def validation_epoch_end(self, outputs):
        ...
        save_path = f'/workspace/Diffusion/ckpts/{config.logger.exp_name}/version_encoder'
...
if __name__ == '__main__':
    ...
    def parse_args_and_config():
        ...
        parser.add_argument("--config", default='/workspace/Diffusion/configs/DTU2.yml', type=str,
                            help="Path to the config file")
        parser.add_argument('--resume', default='/workspace/model.pth.tar', type=str,
        ...
        parser.add_argument("--ckpt_path", default='/workspace/project/dp_simple/CasMVSNet_pl/ckpts/_ckpt_epoch_10.ckpt', type=str,)
    ...
    checkpoint_callback = ModelCheckpoint(dirpath=os.path.join(f'/workspace/Diffusion/ckpts/{config.logger.exp_name}','version_encoder'),
                                          monitor='val/acc_2mm',
                                          mode='max',
                                          every_n_epochs=1.0,
                                          save_last=True,
