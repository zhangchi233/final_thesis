...
python -m accelerate.commands.launch \
  ...
  --finetune-config.io.output_dir /openbayes/input/input0/ViewDiff/output_var_test \
  --finetune-config.io.experiment_name class_different_light \
  ...
  --finetune-config.optimizer.learning_rate 5e-4 \
  --finetune-config.optimizer.vol_rend_learning_rate 1e-4 \
