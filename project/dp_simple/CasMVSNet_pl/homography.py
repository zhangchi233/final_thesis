...
if __name__ == '__main__':
    import sys
    import os
    sys.path.append('/Users/asdfasd/Downloads/文献/test_project/CasMVSNet')
    os.chdir('/Users/asdfasd/Downloads/文献/test_project/CasMVSNet')
    
    from datasets.dtu import DTUDataset

    train_dataset = DTUDataset('/Users/asdfasd/Downloads/文献/test_project/dtu_testing', 'test')
